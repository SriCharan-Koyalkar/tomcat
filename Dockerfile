...
RUN wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.69/bin/apache-tomcat-9.0.69.tar.gz --no-check-certificate
RUN tar -zxvf apache-tomcat-9.0.69.tar.gz -C /opt/tomcat --strip-components=1
